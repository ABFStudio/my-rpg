...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map("world", portals=[
            ...
            NPC("paul", nb_points=4, dialog=["Je m'appelle Paul.", "Bonne aventure."]),
            NPC("robin", nb_points=7, dialog=["Je suis Robin."])
        ])
        ...
        self.register_map("dungeon", portals=[
            ...
            NPC("boss", nb_points=4, dialog=["Je suis le gardien de ces lieux."])
        ])
    ...
    def register_map(self, name, portals=[], npcs=[]):
        # charger la carte qui est au format tmx
        ...
        # Enregitrer la nouvelle carte chargée
